...
Java treeHashSet class provides all optional set operation and permits does not take null elements.
Java treeHashSet class is non synchronized.
Java treeHashSet class maintains insertion order.
Sorting is not possible for null values? bcoz it cant sort null value.
...
public class TreeSetDemo {
	public static void main(String ar[]) {
		...
		Collections.synchronizedSet(treesetdemo);///explicity

		//treesetdemo.add(null);---->NullPointerException 
